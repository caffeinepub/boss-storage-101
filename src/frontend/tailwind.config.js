  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "amber-sm": "0 0 10px oklch(0.75 0.18 70 / 0.2)",
        "amber-md": "0 0 20px oklch(0.75 0.18 70 / 0.3), 0 0 40px oklch(0.75 0.18 70 / 0.1)",
        "card-elevated": "0 4px 24px oklch(0 0 0 / 0.4)",
        "modal": "0 24px 80px oklch(0 0 0 / 0.8)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
