...
import type { ExternalBlob as _ExternalBlob, FileCategory as _FileCategory, FileMetadata as _FileMetadata, Folder as _Folder, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async claimLegacyData(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.claimLegacyData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createFolder(arg0: string, arg1: string): Promise<Folder> {
        if (this.processError) {
            try {
                ...
                return from_candid_Folder_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getFileMetadata(arg0: string): Promise<FileMetadata> {
        if (this.processError) {
            try {
                ...
                return from_candid_FileMetadata_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listFiles(arg0: string | null): Promise<Array<FileMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.listFiles(to_candid_opt_n23(this._uploadFile, this._downloadFile, arg0));
    ...
    async moveFileToFolder(arg0: string, arg1: string | null): Promise<FileMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.moveFileToFolder(arg0, to_candid_opt_n23(this._uploadFile, this._downloadFile, arg1));
                return from_candid_FileMetadata_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async renameFolder(arg0: string, arg1: string): Promise<Folder> {
        if (this.processError) {
            try {
    ...
    async uploadFile(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: Time | null, arg5: FileCategory, arg6: ExternalBlob, arg7: string | null): Promise<FileMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(arg0, arg1, arg2, arg3, to_candid_opt_n26(this._uploadFile, this._downloadFile, arg4), to_candid_FileCategory_n27(this._uploadFile, this._downloadFile, arg5), await to_candid_ExternalBlob_n29(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n23(this._uploadFile, this._downloadFile, arg7));
                return from_candid_FileMetadata_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_FileCategory_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileCategory): FileCategory {
    return from_candid_variant_n21(_uploadFile, _downloadFile, value);
}
async function from_candid_FileMetadata_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileMetadata): Promise<FileMetadata> {
    return await from_candid_record_n17(_uploadFile, _downloadFile, value);
}
function from_candid_Folder_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Folder): Folder {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        exifCaptureTimestamp: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.exifCaptureTimestamp)),
        fileId: value.fileId,
        category: from_candid_FileCategory_n20(_uploadFile, _downloadFile, value.category),
        sizeBytes: value.sizeBytes,
        folderId: record_opt_to_undefined(from_candid_opt_n22(_uploadFile, _downloadFile, value.folderId))
    };
}
...
async function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FileMetadata>): Promise<Array<FileMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FileMetadata_n16(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Folder>): Array<Folder> {
    return value.map((x)=>from_candid_Folder_n10(_uploadFile, _downloadFile, x));
}
...
function to_candid_FileCategory_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileCategory): _FileCategory {
...
function to_candid_variant_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileCategory): {
    pdf: null;
} | {
    audio: null;
} | {
