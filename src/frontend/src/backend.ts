...
import type { ExternalBlob as _ExternalBlob, FileCategory as _FileCategory, FileMetadata as _FileMetadata, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getFileMetadata(arg0: string): Promise<FileMetadata> {
        if (this.processError) {
            try {
                ...
                return from_candid_FileMetadata_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listFiles(arg0: string | null): Promise<Array<FileMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.listFiles(to_candid_opt_n15(this._uploadFile, this._downloadFile, arg0));
    ...
    async moveFileToFolder(arg0: string, arg1: string | null): Promise<FileMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.moveFileToFolder(arg0, to_candid_opt_n15(this._uploadFile, this._downloadFile, arg1));
                return from_candid_FileMetadata_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadFile(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: Time | null, arg5: FileCategory, arg6: ExternalBlob, arg7: string | null): Promise<FileMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(arg0, arg1, arg2, arg3, to_candid_opt_n17(this._uploadFile, this._downloadFile, arg4), to_candid_FileCategory_n18(this._uploadFile, this._downloadFile, arg5), await to_candid_ExternalBlob_n20(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n15(this._uploadFile, this._downloadFile, arg7));
                return from_candid_FileMetadata_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_FileCategory_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileCategory): FileCategory {
    return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
async function from_candid_FileMetadata_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileMetadata): Promise<FileMetadata> {
...
async function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blob: await from_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.blob),
        mimeType: value.mimeType,
        uploadTimestamp: value.uploadTimestamp,
        exifCaptureTimestamp: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.exifCaptureTimestamp)),
        fileId: value.fileId,
        category: from_candid_FileCategory_n12(_uploadFile, _downloadFile, value.category),
        sizeBytes: value.sizeBytes,
        folderId: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.folderId))
    };
}
...
function to_candid_FileCategory_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileCategory): _FileCategory {
...
function to_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileCategory): {
    pdf: null;
} | {
    audio: null;
} | {
